 ...
 * {@hide}
 */
public class MT6797 extends RIL implements CommandsInterface {
    ...
    public MT6797(Context context, int preferredNetworkType, int cdmaSubscription) {
        super(context, preferredNetworkType, cdmaSubscription, null);
    }

    public MT6797(Context context, int preferredNetworkType,
